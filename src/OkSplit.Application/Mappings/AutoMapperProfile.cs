...
public class AutoMapperProfile : Profile
{
    public AutoMapperProfile()
    {
        ...
        // Expenses
        CreateMap<Domain.Entities.Expense, ExpenseResponseDto>()
            .ForMember(d => d.PaidByName, opt => opt.MapFrom(s => s.PaidByUser.FullName))
        ...
        CreateMap<ExpenseSplit, SplitDetailDto>()
            .ForMember(d => d.FullName, opt => opt.MapFrom(s => s.User.FullName))
            .ForMember(d => d.Email, opt => opt.MapFrom(s => s.User.Email));
    }
}
